...
public class DenseLiuShenGpuNVIDIAKernel extends DenseLucasKanadeGpuNVIDIAKernel implements IDenseLiuShenKernel {
    ...
    public DenseLiuShenGpuNVIDIAKernel(int localSizeI, int localSizeJ, int _blockSizeI, int _blockSizeJ,
