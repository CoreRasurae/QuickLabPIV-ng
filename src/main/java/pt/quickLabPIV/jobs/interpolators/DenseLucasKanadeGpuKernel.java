...
import com.aparapi.Kernel.NoCL;
import com.aparapi.Kernel.PrivateMemorySpace;

public class DenseLucasKanadeGpuKernel extends Kernel implements IDenseLucasKanadeKernel {
    public static final int MAX_BLOCK_SIZE_I = 4;
    public static final int MAX_BLOCK_SIZE_J = 4;
    ...
    public DenseLucasKanadeGpuKernel(int localSizeI, int localSizeJ, int _blockSizeI, int _blockSizeJ, 
