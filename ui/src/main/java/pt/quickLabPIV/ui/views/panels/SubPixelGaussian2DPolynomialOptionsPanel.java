...
public class SubPixelGaussian2DPolynomialOptionsPanel extends JPanel implements IPanelWithErrorBorders {

    /**
     * 
     */
    private static final long serialVersionUID = -1181397953200290504L;
    private AutoBinding<SubPixelInterpolationOptionsGaussian2DPolynomialModel, Integer, JFormattedTextField, Object> numberOfPixelsBinding;
    private List<ErrorBorderForComponent> errorBorders = new ArrayList<>(1);

    private AppContextModel appContext;
    private SubPixelInterpolationOptionsGaussian2DPolynomialModel gaussianOptions;
    private JFormattedTextField frmtdTxtFldNumberPixels;

    /**
     * Create the panel.
     */
    public SubPixelGaussian2DPolynomialOptionsPanel() {
        ...
        JLabel lblPixelsLabel = new JLabel("Number of pixels for 2D Centroid fallback");
    ...
    public void setAppContext(AppContextModel model) {
        ...
        gaussianOptions = (SubPixelInterpolationOptionsGaussian2DPolynomialModel)pivModel.getInterpolationOption(SubPixelInterpolationModeEnum.Gaussian2DPolynomial);
        //
    ...
    protected void initDataBindings() {
        BeanProperty<SubPixelInterpolationOptionsGaussian2DPolynomialModel, Integer> subPixelInterpolationOptionsGaussian2DPolyModelBeanProperty = BeanProperty.create("numberOfPixels");
        BeanProperty<JFormattedTextField, Object> jFormattedTextFieldBeanProperty = BeanProperty.create("value");
        numberOfPixelsBinding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, gaussianOptions, subPixelInterpolationOptionsGaussian2DPolyModelBeanProperty, frmtdTxtFldNumberPixels, jFormattedTextFieldBeanProperty, "numberOfPixelsBinding");
