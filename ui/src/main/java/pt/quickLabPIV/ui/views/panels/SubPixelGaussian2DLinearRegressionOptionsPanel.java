...
public class SubPixelGaussian2DLinearRegressionOptionsPanel extends JPanel implements IPanelWithErrorBorders {
    /**
     * 
     */
    private static final long serialVersionUID = -7226746454238307151L;
    private AutoBinding<SubPixelInterpolationOptionsGaussian2DLinearRegressionModel, Integer, JFormattedTextField, Object> numberOfPixelsBinding;
    ...
    private SubPixelInterpolationOptionsGaussian2DLinearRegressionModel gaussianOptions;
    private JFormattedTextField frmtdTxtFldNumberPixels;

    /**
     * Create the panel.
     */
    public SubPixelGaussian2DLinearRegressionOptionsPanel() {
    ...
    public void setAppContext(AppContextModel model) {
        ...
        gaussianOptions = (SubPixelInterpolationOptionsGaussian2DLinearRegressionModel)pivModel.getInterpolationOption(SubPixelInterpolationModeEnum.Gaussian2DLinearRegression);
        //
    ...
    protected void initDataBindings() {
        BeanProperty<SubPixelInterpolationOptionsGaussian2DLinearRegressionModel, Integer> subPixelInterpolationOptionsGaussian2DModelBeanProperty = BeanProperty.create("numberOfPixels");
        BeanProperty<JFormattedTextField, Object> jFormattedTextFieldBeanProperty = BeanProperty.create("value");
        numberOfPixelsBinding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, gaussianOptions, subPixelInterpolationOptionsGaussian2DModelBeanProperty, frmtdTxtFldNumberPixels, jFormattedTextFieldBeanProperty, "numberOfPixelsBinding");
