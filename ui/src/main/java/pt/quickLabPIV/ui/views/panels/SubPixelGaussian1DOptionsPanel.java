...
public class SubPixelGaussian1DOptionsPanel extends JPanel implements IPanelWithErrorBorders {
    private AutoBinding<SubPixelInterpolationOptionsGaussian1DModel, Integer, JFormattedTextField, Object> numberOfPixelsBinding;
    private List<ErrorBorderForComponent> errorBorders = new ArrayList<>(1);

    /**
     * 
     */
    private static final long serialVersionUID = -5709853519482644002L;
    
    private AppContextModel appContext;
    private SubPixelInterpolationOptionsGaussian1DModel gaussianOptions;
    private JFormattedTextField frmtdTxtFldNumberPixels;

    /**
     * Create the panel.
     */
    public SubPixelGaussian1DOptionsPanel() {
    ...
    public void setAppContext(AppContextModel model) {
        ...
        gaussianOptions = (SubPixelInterpolationOptionsGaussian1DModel)pivModel.getInterpolationOption(SubPixelInterpolationModeEnum.Gaussian1D);
        //
    ...
    protected void initDataBindings() {
        BeanProperty<SubPixelInterpolationOptionsGaussian1DModel, Integer> subPixelInterpolationOptionsGaussian1DModelBeanProperty = BeanProperty.create("numberOfPixels");
