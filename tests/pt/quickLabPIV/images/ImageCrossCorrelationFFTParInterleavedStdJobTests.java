...
public class ImageCrossCorrelationFFTParInterleavedStdJobTests {
	...
	public void simpleCrossCorrelationFromImagePass() {
		...
		CrossCorrelationFFTParInterleavedStdJob job = new CrossCorrelationFFTParInterleavedStdJob(device, false, inputMatricesF, inputMatricesG);
		try {
	        job.analyze();
	        job.compute();
		} finally {
