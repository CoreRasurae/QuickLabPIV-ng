 ...
 *
 */
public class AdaptiveInterAreaVelocityInheritanceByDistanceTests {
	...
	public void simpleIASuperPositionDistanceVelocityInheritanceTest1() {		
		...
		parameters.setAreaDivisionStrategy(InterAreaDivisionStrategiesFactoryEnum.SuperPositionStrategy);
