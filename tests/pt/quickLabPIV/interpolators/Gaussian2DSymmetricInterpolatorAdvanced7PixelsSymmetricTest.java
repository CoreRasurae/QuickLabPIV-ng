...
/**
 * Provides unit tests to validate interpolation with a Symmetric standard deviation 2D Gaussian function, over a matrix of 7x7 pixels generated by
 * a 2D Symmetric Gaussian function with no noise added.
 * 
 * @author lpnm
 */
public class Gaussian2DSymmetricInterpolatorAdvanced7PixelsSymmetricTest {
    ...
    @Test
    public void deviated03LeftSigma03() {
        float uX = -0.3f;
        float uY = -0.3f;
        float sigmaX = 0.35f;
        float sigmaY = 0.35f;
    ...
    @Test
    public void deviated03RightSigma03() {
        float uX = 0.3f;
        float uY = 0.3f;
        float sigmaX = 0.35f;
        float sigmaY = 0.35f;
