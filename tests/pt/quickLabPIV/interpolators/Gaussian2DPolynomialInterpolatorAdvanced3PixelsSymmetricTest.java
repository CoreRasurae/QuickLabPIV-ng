 ...
 * @author lpnm
 */
public class Gaussian2DPolynomialInterpolatorAdvanced3PixelsSymmetricTest {
    ...
    public void centeredSigma10() {
        ...
        MaxCrossResult result = GaussianTestHelper.setupPIVContextGaussian2DPoly(context, DIM_X);
        ...
        assertEquals("Interpolation incorrectly deviated in I direction from integer max.", uY + (float)(DIM_Y/2), result.getMainPeakI(), 1e-5f);
        assertEquals("Interpolation incorrectly deviated in J direction from integer max.", uX + (float)(DIM_X/2), result.getMainPeakJ(), 1e-5f);
    }
