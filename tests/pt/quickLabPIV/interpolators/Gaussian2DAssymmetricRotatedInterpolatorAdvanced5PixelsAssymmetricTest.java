...
/**
 * Provides unit tests to validate interpolation with a Assymmetric standard deviation 2D Gaussian function with rotation, over a matrix of 5x5 pixels generated by
 * an 2D Assymmetric Gaussian function with no noise added.
 * 
 * @author lpnm
 */
public class Gaussian2DAssymmetricRotatedInterpolatorAdvanced5PixelsAssymmetricTest {
    private static final int DIM_X = 5;
    private static final int DIM_Y = 5;
